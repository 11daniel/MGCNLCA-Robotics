...
while True:
    ...
    if(pin0.read_analog() >= 500 and pin1.read_analog() >= 500):
        r.motor_on(r.MOTOR_1, r.FORWARD, 30)
        r.motor_on(r.MOTOR_2, r.FORWARD, 30)
        time.sleep_ms(100)

    # both sees black
    elif(pin0.read_analog() <= 500 and pin1.read_analog() <= 500):
        r.motor_on(r.MOTOR_1, r.FORWARD, 30)
        r.motor_on(r.MOTOR_2, r.FORWARD, 30)
        time.sleep_ms(200)
    ...
    # pin0 sees black
        ...
        r.motor_on(r.MOTOR_1, r.FORWARD, 25)
        r.motor_on(r.MOTOR_2, r.FORWARD, 0)
        time.sleep_ms(300)

    # pin1 sees black
    elif(pin0.read_analog() >= 500 and pin1.read_analog() <= 500):
        r.motor_on(r.MOTOR_1, r.FORWARD, 0)
        r.motor_on(r.MOTOR_2, r.FORWARD, 25)
        time.sleep_ms(300)